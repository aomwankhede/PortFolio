      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText}`}>
            Hi, I'm <span className="text-[#915eff]">Aom</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I develop fullStack webApps <br className="sm:block hidden" />
            Using MERN
          </p>
        </div>
      </div>
      <ComputersCanvas/>
      <div className="absolute xs:bottom-10 bottom-32 w-full flex justify-center items-center" style={{position:'absolute',bottom:'10px'}}>
        <a href="#about">
